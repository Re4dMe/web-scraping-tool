    ...
    */
    ...
    return (
        <div style={{display: "flex", flexDirection: "column"}}>
            <SubTaskBoard tasks={tasks["active"]} name="Active" />
            <SubTaskBoard tasks={tasks["pending"]} name="Pending" />
            <SubTaskBoard tasks={tasks["inactive"]} name="Inactive" />
        </div>
    );
}
